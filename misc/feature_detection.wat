...
;;
;;   wat2wasm --enable-simd -v misc/feature_detection.wat -o misc/feature_detection.wasm
;;   python misc/replace_bytes.py misc/feature_detection.wasm fdd5 fdba # replace `i64x2.mul` with `i32x4.dot_i16x8_s`
;;   python -c 'print([*open("misc/feature_detection.wasm", "rb").read()])'
